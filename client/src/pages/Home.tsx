    ...
    <div className="mx-auto flex min-h-screen max-w-[1500px] flex-col lg:flex-row">
      ...
      <main className="flex min-h-[calc(100vh-1px)] min-w-0 flex-1 flex-col px-4 py-5 sm:px-8 sm:py-8 lg:px-12 lg:py-10">
        ...
        <section className="mx-auto flex w-full max-w-5xl flex-1 flex-col pt-7 sm:pt-9">
          ...
          {chatMutation.isError && <p className="mt-3 text-center text-xs text-red-600 dark:text-red-300">{chatMutation.error.message}</p>}<p className="mt-4 text-center text-[11px] text-[#9a938b] dark:text-[#8290a4]">Keiland AI dapat membuat kesalahan. Periksa kembali informasi penting.</p>
        </section>
      </main>
    </div>
  </div>;
